...
// API Endpoints
const endpoints = [
    "http://127.0.0.1:5000/api/v1.0/mortality_rate_myocardial",
    "http://127.0.0.1:5000/api/v1.0/mortality_rates_ischemics",
    "http://127.0.0.1:5000/api/v1.0/mortality_rates_heart_failure"
];
